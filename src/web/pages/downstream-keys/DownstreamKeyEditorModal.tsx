              ...
              <div className="downstream-key-advanced-panel">
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
                  <div>
                    ...
                    <div className="downstream-key-modal-help">只展示精确模型；未勾选表示不限制，允许所有精确模型。一旦勾选，则只允许选中的模型。</div>
                  </div>
              ...
              <div className="downstream-key-advanced-panel">
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
                  <div>
                    ...
                    <div className="downstream-key-modal-help">限制可访问的群组路由；未勾选表示不限制，允许所有群组。一旦勾选，则只允许选中的群组。</div>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
