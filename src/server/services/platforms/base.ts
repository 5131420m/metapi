...
export interface PlatformAdapter {
  ...
  getModels(baseUrl: string, token: string, platformUserId?: number, options?: { signal?: AbortSignal }): Promise<string[]>;
...
export abstract class BasePlatformAdapter implements PlatformAdapter {
  ...
  abstract getModels(baseUrl: string, token: string, platformUserId?: number, options?: { signal?: AbortSignal }): Promise<string[]>;
