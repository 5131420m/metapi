...
export const sites = sqliteTable('sites', {
  ...
  codexIdentityMode: text('codex_identity_mode').default('off'), // 'off' | 'synthesize'
...
export const siteApiEndpoints = sqliteTable('site_api_endpoints', {
  ...
  consecutiveFailureCount: integer('consecutive_failure_count').default(0),
  failureWindowStartedAt: text('failure_window_started_at'),
  lastFailureScopeId: text('last_failure_scope_id'),
